...
try {
		Debug.PushSubsStack("DialogClosed (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("GetPanel (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("getText (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("Hide (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("Initialize (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("setText (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Show (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("ShowDialog (b4xprogressdialog) ","b4xprogressdialog",33,__ref.getField(false, "ba"),__ref,39);
