...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",calendario.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.example.b4xcollections.class),"CLV_Calendario",calendario.mostCurrent._clv_calendario,"DateUtils",calendario.mostCurrent._dateutils,"fechasConAtencion",calendario.mostCurrent._fechasconatencion,"Lbl_dia",calendario.mostCurrent._lbl_dia,"listaAtenciones",calendario.mostCurrent._listaatenciones,"Main",Debug.moduleToString(b4a.example.main.class),"Menu",Debug.moduleToString(b4a.example.menu.class),"Modulo_Seleccion",Debug.moduleToString(b4a.example.modulo_seleccion.class),"ModuloGestion",Debug.moduleToString(b4a.example.modulogestion.class),"PanelDia",calendario.mostCurrent._paneldia,"Registrar",Debug.moduleToString(b4a.example.registrar.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"xui",calendario.mostCurrent._xui,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}