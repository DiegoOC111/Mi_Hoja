...
try {
		Debug.PushSubsStack("CreateBitSet (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,53);
...
try {
		Debug.PushSubsStack("CreateList (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,104);
...
try {
		Debug.PushSubsStack("CreateOrderedMap (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,31);
...
try {
		Debug.PushSubsStack("CreateOrderedMap2 (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,39);
...
try {
		Debug.PushSubsStack("CreateSet (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,10);
...
try {
		Debug.PushSubsStack("CreateSet2 (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,17);
...
try {
		Debug.PushSubsStack("GetEmptyList (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,69);
...
try {
		Debug.PushSubsStack("GetEmptyMap (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,60);
...
try {
		Debug.PushSubsStack("MergeLists (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,95);
...
try {
		Debug.PushSubsStack("MergeMaps (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,78);
...
try {
		Debug.PushSubsStack("ShuffleList (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,112);
...
try {
		Debug.PushSubsStack("SubList (b4xcollections) ","b4xcollections",10,_ba,b4xcollections.mostCurrent,123);
