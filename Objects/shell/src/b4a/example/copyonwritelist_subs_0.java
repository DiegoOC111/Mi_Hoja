...
try {
		Debug.PushSubsStack("Add (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("AddAll (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("AddAllAt (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("Clear (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("Get (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("GetList (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,84);
...
try {
		Debug.PushSubsStack("getSize (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("IndexOf (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("Initialize (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("InsertAt (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("MakeCopy (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("RemoveAt (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("Set (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("Sort (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("SortCaseInsensitive (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("SortType (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("SortTypeCaseInsensitive (copyonwritelist) ","copyonwritelist",15,__ref.getField(false, "ba"),__ref,78);
