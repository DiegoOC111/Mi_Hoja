...
try {
		Debug.PushSubsStack("Clear (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("ContainsKey (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("CopyMap (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("Get (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("GetDefault (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("GetMap (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("getSize (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("Initialize (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Put (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Remove (copyonwritemap) ","copyonwritemap",15,__ref.getField(false, "ba"),__ref,35);
