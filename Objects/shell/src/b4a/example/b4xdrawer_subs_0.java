...
try {
		Debug.PushSubsStack("Base_OnInterceptTouchEvent (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("Base_OnTouchEvent (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("ChangeOffset (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,175);
...
try {
		Debug.PushSubsStack("getCenterPanel (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,241);
...
try {
		Debug.PushSubsStack("getGestureEnabled (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,253);
...
try {
		Debug.PushSubsStack("getLeftOpen (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,226);
...
try {
		Debug.PushSubsStack("getLeftPanel (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,237);
...
try {
		Debug.PushSubsStack("Initialize (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("LeftPanel_Click (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("OffsetToColor (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,221);
...
try {
		Debug.PushSubsStack("Resize (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,245);
...
try {
		Debug.PushSubsStack("setGestureEnabled (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("SetIsOpen (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,213);
...
try {
		Debug.PushSubsStack("setLeftOpen (b4xdrawer) ","b4xdrawer",15,__ref.getField(false, "ba"),__ref,230);
