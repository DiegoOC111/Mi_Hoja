...
try {
		Debug.PushSubsStack("ContainsKey (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("CreateB4XCacheItem (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("Get (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("getMaxSize (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Initialize (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,9);
...
try {
		Debug.PushSubsStack("IsEternal (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Keys (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("Put (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("PutEternal (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("Remove (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("RemoveOldItems (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,82);
...
try {
		Debug.PushSubsStack("setMaxSize (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Size (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("TrimIfOversize (b4xcache) ","b4xcache",9,__ref.getField(false, "ba"),__ref,70);
