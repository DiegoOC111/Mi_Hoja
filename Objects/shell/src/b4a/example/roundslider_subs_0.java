...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,64);
...
try {
		Debug.PushSubsStack("SetRange (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,176);
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",39,__ref.getField(false, "ba"),__ref,170);
